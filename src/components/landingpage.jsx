            ...
            <section className="bg-center bg-no-repeat bg-[url('https://res.cloudinary.com/dggfjc8rb/image/upload/v1716289115/Dutch%20Strength/DS_Wide_ij2tvb.jpg')] bg-gray-700 bg-blend-multiply bg-cover">
                <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                    ...
                    <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                        ...
                        <a href="#" class="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-orange-200 focus:ring-4 focus:ring-gray-400">
                            Learn more
                        </a>
                    </div>
                </div>
