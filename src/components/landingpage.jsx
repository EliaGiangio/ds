            ...
            <section className="bg-center bg-no-repeat bg-[url('https://res.cloudinary.com/dggfjc8rb/image/upload/v1716289115/Dutch%20Strength/DS_Wide_ij2tvb.jpg')] bg-gray-700 bg-blend-multiply bg-cover">
                <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                    ...
                    <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                        <a className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900" onClick={() => navigate('/ds/#pricing')}>
                            Book a sesh
